...
export default async function InterceptedAssetModal({ params }: PageProps) {
  ...
  if (asset.media_type === "document") {
    ...
    // Notice this redirects out of the modal intercept entirely.
  ...
  return (
    <Modal>
      <div className="flex flex-col md:flex-row w-full h-full bg-black text-zinc-900 font-sans">
        
        {/* Media Presentation Side (Left - Dark) */}
        <div className="flex-1 lg:w-[80%] relative flex items-center justify-center p-8 min-h-[40vh] md:min-h-[auto] overflow-hidden group">
